	...
	public class MegaBookPageAttach : MonoBehaviour
	{
		...
		void LateUpdate()
		{
			if ( book )
			{
				...
				Vector3 v0 = pg.jsverts[BaryVerts[0]];
				Vector3 v1 = pg.jsverts[BaryVerts[1]];
				Vector3 v2 = pg.jsverts[BaryVerts[2]];
				...
				v0 = pg.jsverts[BaryVerts1[0]];
				v1 = pg.jsverts[BaryVerts1[1]];
				v2 = pg.jsverts[BaryVerts1[2]];
		...
		public void AttachItUV()
		{
			if ( book )
			{
				...
				Vector3[] verts = pobj.verts;	//.ToArray();
