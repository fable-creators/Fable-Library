...
### LoadWebAudioClip
```csharp
public IEnumerator LoadWebAudioClip(String blobUrl, Boolean isPageTurnSound)
```

### HandleLoadedAudioClip
```csharp
public Void HandleLoadedAudioClip(AudioClip clip, Boolean isPageTurnSound)
```
